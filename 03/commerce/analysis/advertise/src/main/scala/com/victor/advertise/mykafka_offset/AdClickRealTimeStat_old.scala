...
/**
  ...
  */
object AdClickRealTimeStat_old {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val adRealTimeLogDStream=KafkaUtils.createDirectStream[String,String,StringDecoder, StringDecoder](ssc,kafkaParam,Set(topics))

    var adRealTimeValueDStream = adRealTimeLogDStream.map(_._2)
